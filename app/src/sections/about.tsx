  ...
  return (
      <section className="relative flex justify-center min-h-[55rem] h-auto overflow-hidden bg-[#C6B7CE]">
          ...
          <div className="relative flex flex-col self-start mt-10 gap-19 text-center lg:mt-15">
              <h1 className="appear text-5xl lg:text-6xl font-semibold uppercase max-w-[800px] z-10">{t("about.title")}</h1>
              
              <p className="text-2xl sm:text-3xl font-medium max-w-[800px] z-10">{t("about.p1")}</p>
              
              <p className="text-2xl sm:text-3xl font-medium max-w-[800px] z-10">{t("about.p2")}</p>
          </div>
